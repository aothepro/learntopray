...
with_node \
  ...
  --target "/Users/ashrafomar/Desktop/prayerapp/ios/Pods/Target Support Files/Pods-prayerapp/ExpoModulesProvider.swift" \
  --entitlement "/Users/ashrafomar/Desktop/prayerapp/ios/prayerapp/prayerapp.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-audio" "expo-blur" "expo-constants" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
